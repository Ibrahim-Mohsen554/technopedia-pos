                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-pro_id="{{ $product->id }}" data-product_name="{{ $product->product_name }}" data-toggle="modal" href="#deleteproduct"
                                                title="delete Product"><i class="las la-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_description" id="product_description" class="form-control" placeholder="Description" rows="3"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="brand_name">Brand Name</label>
                                        <select class="form-control select2-no-search" name="brand_name" id="brand_name" disabled>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_desc" id="product_desc" class="form-control" placeholder="Description" rows="3"
                                            spellcheck="false"></textarea>
                                    </div>
                                </div>
                            </div>
...
<script src="{{URL::asset('assets/js/table-data.js')}}"></script>
    ...
    <script>
        ...
        $('#editproduct').on('show.bs.modal', function(event) {
            ...
            console.log(Qty_instock);

            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #sku_num').val(sku_num);
            modal.find('.modal-body #product_name').val(product_name);
            modal.find('.modal-body #product_desc').val(product_desc);
